...
graph LR
    ...
    %% Azul relleno con texto blanco
    classDef blueBox fill:#1f55a8,stroke:#1f55a8,color:white,rx:5,ry:5;
    
    %% Blanco con borde azul y texto azul oscuro
    classDef whiteBox fill:white,stroke:#1f55a8,color:#0e2a5c,stroke-width:2px,rx:5,ry:5;

    %% Asignación de estilos a los nodos
    class B,F blueBox;
    class A,C,D,E,G,H whiteBox;
```
## Requisitos Previos
